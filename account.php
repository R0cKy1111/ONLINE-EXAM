...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
	...
	<li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="account.php?q=3"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;WRITTEN ASSIGNMENT</a></li></ul>
...
echo "<h3 class='text-center'>Available Tests For Today For ICT3715</h3>";
