...
<div class="form-group">
<input type="text" name="uname" maxlength="200"  placeholder="Admin Email" class="form-control"/> 
</div>
<div class="form-group">
<input type="password" name="password" maxlength="150" placeholder="Password" class="form-control"/>
</div>
